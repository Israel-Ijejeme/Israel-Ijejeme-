          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                With 6 years of experience, I have honed my skills in both frontend and mobile dev, creating dynamic
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">ijejemeisrael@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
